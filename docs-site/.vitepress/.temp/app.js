...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"Read Only View","description":"Keep selected Obsidian notes in Reading view and prevent accidental edits with local include and exclude path rules.","base":"/Read-Only-View/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"nav":[{"text":"Guides","link":"/guides/make-note-read-only"},{"text":"Path rules","link":"/docs/path-rules"},{"text":"FAQ","link":"/faq"}],"sidebar":[{"text":"Guides","items":[{"text":"Keep all notes in Reading view","link":"/guides/make-all-notes-read-only"},{"text":"Make a note read-only","link":"/guides/make-note-read-only"},{"text":"Make a folder read-only","link":"/guides/make-folder-read-only"},{"text":"Prevent accidental editing","link":"/guides/prevent-accidental-editing"},{"text":"Reading view on mobile","link":"/guides/mobile-reading-view"}]},{"text":"Documentation","items":[{"text":"Path rules","link":"/docs/path-rules"},{"text":"Path tester","link":"/docs/path-tester"},{"text":"Troubleshooting","link":"/docs/troubleshooting"},{"text":"FAQ","link":"/faq"}]}],"socialLinks":[{"icon":"github","link":"https://github.com/mrKazzila/Read-Only-View"}],"footer":{"message":"Released under the 0BSD license."}},"locales":{},"scrollOffset":134,"cleanUrls":true}'));
